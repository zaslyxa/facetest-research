...
Если Supabase не примет итоговые ответы после повторных попыток, браузер предложит скачать аварийный CSV-файл. Участник может отправить его исследователю вручную.
